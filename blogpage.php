          ...
          <div class="row">
            <div class="col-sm-7 col-md-8 col-xs-12 blog_left">
              <article class="blog_detail">
                <div>
                  <h2 class="blog_title"><a href="blog_detail.html">Lorem ipsum dolor sit amet</a></h2>
                  <p class="upload_info"> <span class="date"><i class="fa fa-calendar" aria-hidden="true"></i> June 1st, 2018</span> <span class="cmnt"><a href="#"><i class="fa fa-comment" aria-hidden="true"></i> 5</a></span> <span class="like"><i class="fa fa-heart-o" aria-hidden="true"></i> 220</span> </p>
                </div>
                <div class="blog_main_img"><a href="blog_detail.html"><img class="img-responsive" src="assets/images/blog_page.png" alt=""></a></div>
                ...
                <div class="read_social col-sm-12 col-xs-12">
                  <div class="row">
                    <div class="pull-left"><a href="#"> Read more <i class="fa fa-long-arrow-right" aria-hidden="true"></i> </a></div>
                    <div class="pull-right"> <a class="fa fa-facebook-f" href="#"></a> <a class="fa fa-twitter" href="#"></a><a class="fa fa-instagram" href="#"></a> </div>
                  </div>
                </div>
              </article>
              <article class="blog_detail">
              ...
              <div class="pagination"> <a href="#" class="pre"><i class="fa fa-angle-left" aria-hidden="true"></i></a> <a href="#">1</a> <a class="active" href="#">2</a> <a href="#">3</a> <a href="#">4</a> <a href="#" class="next"><i class="fa fa-angle-right" aria-hidden="true"></i></a> </div>
            </div>
            <div class="col-sm-5 col-md-4 col-xs-12 blog_right">
              ...
              <article class="articles_blog">
                ...
                <ul>
                  <li class="articles col-sm-12 col-xs-12 colmd-12">
                    <div class="row">
